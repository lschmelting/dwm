...
static const char *fonts[]          = { "Siji:size=12", "Terminus:size=11" };
...
static const Rule rules[] = {
	...
	{ "Pavucontrol", 	NULL,     NULL,			1 << 4,    0,          0,          -1,        -1 },
	{ "Element", 		NULL,     NULL,   		1 << 5,    0,          0,          -1,        -1 },
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_numbersign,  spawn,  	{.v = rangercmd } },
	{ MODKEY,                       XK_dead_acute,  togglescratch,  {.v = scratchpadcmd } },
	{ MODKEY,                       XK_s,  		spawn,  	SHCMD("/home/l4s8g/.scripts/screenshot.sh")  },
